...
#define LV_THEME_DEFAULT_INIT               lv_theme_material_init // We init the theme ourselves
...
#  define LV_SPINNER_DEF_ANIM         LV_SPINNER_TYPE_CONSTANT_ARC // LV_SPINNER_TYPE_SPINNING_ARC
#endif
